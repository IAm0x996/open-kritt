...
def build_pre_step_3_dedupe_prompt(
    *,
    ...
    return (
        "You are performing a conservative semantic duplicate check between Step 3 candidates.\n"
        ...
        "Do not mark candidates duplicate merely because they concern the same subsystem, vulnerability "
