...
<Steps>
  ...
  <Step title="Model and harness">
    The [model, provider, harness, and thinking effort](/scans/model-and-harness) to run
    with.
  </Step>
...
Replace the IDs and model with values available in your installation. This example pins
the target commit, adds a remote dependency, attaches a skill and two post-scripts, and
uses OpenRouter through Claude Code:
