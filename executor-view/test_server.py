...
class ExecutorViewSummaryTests(unittest.TestCase):
    ...
    def test_duplicate_attempt_includes_both_candidate_results(self):
        ...
        results = {
            101: {"id": 101, "json_answer": {"candidate": "candidate A"}},
            102: {"id": 102, "json_answer": {"candidate": "candidate B"}},
        }
        ...
        self.assertEqual(attempt["duplicateInput"]["json"], {"candidate": "candidate A"})
        self.assertEqual(attempt["duplicateTarget"]["json"], {"candidate": "candidate B"})
